...
function numberExtenso(number) {
  ...
  //Valores com 3 algarimos
    ...
    if ((number[0] == '1' || number[0] == '2' || number[0] == '3' || number[0] == '4' || number[0] == '5' || number[0] == '6' || number[0] == '7' || number[0] == '8' || number[0] == '9') && (number[1] == '0' && number[2] == '0')) {
      document.write(centenas[parseInt(number[0] - 1)])
    }
    ...
    //Centenas + números especiais
      ...
      document.write(centenas[parseInt(number[0] - 1)] + " e " + especiais[parseInt(number[2])])
    }
    ...
    //Centenas + Nº Compostos
      ...
      document.write(centenas[parseInt(number[0] - 1)] + " e " + dezenas[parseInt(number[1] - 2)] + " e " + unidades[parseInt(number[2])]);
    }
    ...
    //Cento + Nº Especiais
      ...
      document.write("Cento e " + especiais[parseInt(number[2])])
    }

    //Cento + Nº Compostos
    else if ((number[0] == '1') && (number[1] != '1') && (number[2] != '0')) {
      document.write("Cento e " + dezenas[parseInt(number[1] - 2)] + " e " + unidades[parseInt(number[2])]);
    }
  }
}